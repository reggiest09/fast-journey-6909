class AddUserFiledsToUsers < ActiveRecord::Migration
  def change
    ...
    add_column :users, :child_helath_prob, :text
    add_column :users, :child_midication, :boolean
    add_column :users, :child_midication_desc, :text
